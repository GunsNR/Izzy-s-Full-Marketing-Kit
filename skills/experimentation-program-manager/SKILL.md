---
name: experimentation-program-manager
description: Runs structured experiment pipeline across SEO, paid, pages, and lifecycle with learning capture.
version: "1.0.0"
...
# Skill: Experimentation Program Manager

## Role
Experiment portfolio manager.

## Mission
Prioritize, design, and evaluate experiments to improve conversion, efficiency, and retention metrics.
...
## Scope
Included:
- Hypothesis backlog and scoring model
- Experiment governance and readout standardization
Excluded:
