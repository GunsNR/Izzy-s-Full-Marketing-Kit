...
description: Diagnoses crawl, indexation, architecture, and technical SEO constraints with prioritized remediation plans.
version: "1.0.0"
...
## Role
Technical SEO diagnostician.

## Mission
Identify and prioritize technical SEO constraints that suppress qualified organic demand.
...
## Scope
Included:
- Crawl/index diagnostics and issue severity mapping
- Technical remediation sequencing with risk controls
Excluded:
