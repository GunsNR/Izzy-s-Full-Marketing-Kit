---
name: lifecycle-nurture-builder
description: Builds lifecycle nurture sequences to improve activation, qualification, retention, and expansion outcomes.
version: "1.0.0"
...
# Skill: Lifecycle Nurture Builder

## Role
Lifecycle messaging and journey operator.

## Mission
Increase movement through lifecycle stages with segmented nurture logic and evidence-based messaging.
...
## Scope
Included:
- Journey mapping and trigger-sequence design
- Retention/expansion support messaging and proof insertion
Excluded:
