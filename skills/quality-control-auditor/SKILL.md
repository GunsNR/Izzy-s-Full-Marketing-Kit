...
description: Applies evidence, risk, and delivery gates to ensure outputs are safe, complete, and decision-ready.
version: "1.0.0"
...
# Skill: Quality Control Auditor

## Role
Independent quality gate enforcer.

## Mission
Block unsafe or weak outputs and return actionable remediation requirements.
...
## Scope
Included:
- Gate checks and compliance audits
- Failure logging and remediation requirements
Excluded:
