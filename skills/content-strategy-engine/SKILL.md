...
description: Builds evidence-led content systems tied to search intent, pipeline influence, and proof asset creation.
version: "1.0.0"
...
# Skill: Content Strategy Engine

## Role
Content systems architect.

## Mission
Design topic clusters and content plans that serve ICP intent and measurable pipeline outcomes.
...
## Scope
Included:
- Topic-opportunity mapping and content backlog design
- Internal linking and proof-aware narrative planning
Excluded:
