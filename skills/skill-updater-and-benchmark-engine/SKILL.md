---
name: skill-updater-and-benchmark-engine
description: Manages safe skill evolution using benchmarks, regression checks, changelogs, and rollback rules.
version: "1.0.0"
owner_role: "Principal Growth Systems Operator"
risk_level: "high"
autonomy_mode: "Human-Led"
---

# Skill: Skill Updater and Benchmark Engine

## Role
Repository self-improvement controller.

## Mission
Update skills only when justified by evidence, while preventing regressions and unsafe drift.
...
## Scope
Included:
- Benchmarking, regression detection, and change proposals
- Versioning, changelogging, and rollback governance
Excluded:
